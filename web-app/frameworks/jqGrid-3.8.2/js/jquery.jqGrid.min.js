...
(function(b) {
    ...
    b.extend(b.jgrid, {htmlDecode:function(f) {
                ...
                if (j && j !== null && j !== undefined) {
                    ...
                    f = i.y;
                    if (f >= 70 && f <= 99)i.y = 1900 + i.y; else if (f >= 0 && f <= 69)i.y = 2E3 + i.y
                }
                ...
                return new (function(j, i) {
                    ...
                    this.startsWith = function(l, m) {
                        ...
                        if (N)c._append(c._getStr("this." + l) + ".substr(0," + q + ") == " + c._getStr('"' + c._toStr(m) + '"')); else {
            ...
            if (!this.grid) {
                var c = b.extend(true, {url:"",height:150,page:1,rowNum:20,rowTotal:null,records:0,pager:"",pgbuttons:true,pginput:true,colModel:[],rowList:[],colNames:[],sortorder:"asc",sortname:"",datatype:"xml",mtype:"GET",altRows:false,selarrrow:[],
                            ...
                            scrollrows:false,autowidth:false,scrollOffset:18,cellLayout:5,subGridWidth:20,multiselectWidth:20,gridview:false,rownumWidth:25,rownumbers:false,pagerpos:"center",recordpos:"right",footerrow:false,userDataOnFooter:false,hoverrows:true,altclass:"ui-priority-secondary",viewsortcols:[false,"vertical",true],resizeclass:"",autoencode:false,remapColumns:[],ajaxGridOptions:{},direction:"ltr",toppager:false,headertitles:false,scrollTimeout:40,data:[],_index:{},grouping:false,groupingView:{groupField:[],groupOrder:[],
                                groupText:[],groupColumnShow:[],groupSummary:[],showSummaryOnHide:false,sortitems:[],sortnames:[],groupDataSorted:false,summary:[],summaryval:[],plusicon:"ui-icon-circlesmall-plus",minusicon:"ui-icon-circlesmall-minus"},ignoreCase:false,cmTemplate:{}}, b.jgrid.defaults, f || {}),e = {headers:[],cols:[],footers:[],dragStart:function(d, g, h) {
                    this.resizing = {idx:d,startX:g.clientX,sOL:h[0]};
                    this.hDiv.style.cursor = "col-resize";
                    this.curGbox = b("#rs_m" + c.id, "#gbox_" + c.id);
                    this.curGbox.css({display:"block",left:h[0],
                                top:h[1],height:h[2]});
                    ...
                    if (d) {
                        ...
                        if (h) {
                            ...
                            h = h * o;
                            var C,G,s;
                            if (w < d && x <= 0 && (c.lastpage ===
                                    undefined || parseInt((w + p + h - 1) / h, 10) <= c.lastpage)) {
                            ...
                            if (G)if (!(c.lastpage && C > c.lastpage || c.lastpage == 1))if (e.hDiv.loading)e.timer = setTimeout(e.populateVisible, c.scrollTimeout); else {
                                c.page = C;
                                if (s) {
                    ...
                    g.gridComplete = function() {
                        g.selrow = null;
                        g.selarrrow = [];
                        if (g.multiselect && o && o.length > 0)for (var w = 0; w < o.length; w++)o[w] != h && b(d).jqGrid("setSelection", o[w],
                                false);
                ...
                if (this.tagName != "TABLE")alert("Element is not a table"); else {
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length)alert(b.jgrid.errors.model); else {
                                ...
                                function(d, g, h, o, p) {
                                    ...
                                    if (b.isXMLDoc(d)) {
                                        ...
                                        if (z.length > 0 && !isNaN(Q)) {
                                            if (a.p.remapColumns &&
                                                    a.p.remapColumns.length)Q = b.inArray(Q, a.p.remapColumns);
                                            Q = z[Q]
                                        }
                                ...
                                b.each(a.p.colModel, function() {
                                    ...
                                    if (w == "date" || w == "datetime") {
                                        if (this.formatter && typeof this.formatter === "string" && this.formatter == "date") {
                                            ...
                                            C = this.formatoptions && this.formatoptions.newformat ? this.formatoptions.newformat :
                                                    b.jgrid.formatter.date.newformat
                                        } else x = C = this.datefmt || "Y-m-d";
                                        h[this.name] = {stype:w,srcfmt:x,newfmt:C}
                                    } else h[this.name] = {stype:w,srcfmt:"",newfmt:""};
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (b.isFunction(a.p.datatype))a.p.datatype.call(a, a.p.postData, "load_" + a.p.id); else {
                                    ...
                                    switch (o) {
                                        ...
                                        case "xml":
                                        case "script":
                                            b.ajax(b.extend({url:a.p.url,type:a.p.mtype,dataType:o,data:b.isFunction(a.p.serializeGridData) ?
                                                            a.p.serializeGridData.call(a, a.p.postData) : a.p.postData,success:function(s) {
                        ...
                        B = function(d, g) {
                            ...
                            C = d + "_center";
                            G = d + "_right";
                            b("#" + d).append("<div id='" + x + "' class='ui-pager-control' role='group'><table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table' style='width:100%;table-layout:fixed;height:100%;' role='row'><tbody><tr><td id='" +
                                    w + "' align='left'></td><td id='" + C + "' align='center' style='white-space:pre;'></td><td id='" + G + "' align='right'></td></tr></tbody></table></div>").attr("dir", "ltr");
                            ...
                            if (n == "rtl")o += p;
                            if (a.p.pginput === true)h = "<td dir='" +
                                    n + "'>" + b.jgrid.format(a.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1'></span>") + "</td>";
                            if (a.p.pgbuttons === true) {
                                ...
                                o += h !== "" ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" +
                                        h + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" : "";
                            ...
                            if (n == "ltr")o += p;
                            o += "</tr></tbody></table>";
                            a.p.viewrecords === true && b("td#" + d + "_" + a.p.recordpos, "#" + x).append("<div dir='" + n + "' style='text-align:" + a.p.recordpos +
                            ...
                            b(".ui-pg-selbox",
                                    "#" + x).bind("change", function() {
                                        ...
                                        if (g)b(".ui-pg-selbox", a.p.pager).val(this.value); else a.p.toppager && b(".ui-pg-selbox", a.p.toppager).val(this.value);
                            ...
                            if (a.p.pgbuttons === true) {
                                ...
                                b("#first" + g + ", #prev" + g + ", #next" + g + ", #last" + g, "#" + d).click(function() {
                                    ...
                                    if (y === 0 || y === 1)Q = E = H = K = false; else if (y > 1 && v >= 1)if (v === 1)H = K = false; else {
                        ...
                        var Ca = function(d, g, h, o) {
                            if (a.p.colModel[g].sortable)if (!(a.p.savedRow.length > 0)) {
                                if (!h) {
                                    if (a.p.lastsort == g)if (a.p.sortorder == "asc")a.p.sortorder = "desc"; else {
                                        if (a.p.sortorder == "desc")a.p.sortorder = "asc"
                                    } else a.p.sortorder = a.p.colModel[g].firstsortorder ||
                                            "asc";
                                    a.p.page = 1
                                }
                                if (o)if (a.p.lastsort == g && a.p.sortorder == o && !h)return; else a.p.sortorder = o;
                        ...
                        if (this.p.rownumbers) {
                            ...
                            this.p.colModel.unshift({name:"rn",width:a.p.rownumWidth,
                        ...
                        la = ma = "";
                        if (a.p.shrinkToFit === true && a.p.forceFit === true)for (k = a.p.colModel.length - 1; k >=
                                0; k--)if (!a.p.colModel[k].hidden) {
                        ...
                        (function() {
                            var d = 0,g = a.p.cellLayout,
                                    h = 0,o,p = a.p.scrollOffset,x,w = false,C,G = 0,s = 0,v = 0,y;
                            if (S)g = 0;
                            b.each(a.p.colModel, function() {
                            ...
                            if (isNaN(a.p.width))a.p.width = e.width = d; else e.width = a.p.width;
                            a.p.tblwidth = d;
                        ...
                        b("th", t).each(
                                function(d) {
                                    ...
                                    if (typeof ta !==
                                            "boolean")ta = a.p.colModel[d].sortable = true;
                                    ...
                                    if (a.p.footerrow)va += "<td role='gridcell' " + l(d, 0, "") +
                                            ">&#160;</td>"
                                }).mousedown(
                                function(d) {
                        ...
                        b(a).before(e.hDiv).click(
                                function(d) {
                                    ...
                                    if (h === true) {
                                        if (a.p.cellEdit === true)if (a.p.multiselect && g)b(a).jqGrid("setSelection", R[0].id, true); else {
                                            ja = R[0].rowIndex;
                                        ...
                                        } else if (a.p.multikey)if (d[a.p.multikey])b(a).jqGrid("setSelection", R[0].id, true); else {
                                            if (a.p.multiselect &&
                                                    g) {
                        ...
                        b(e.bDiv).append(b('<div style="position:relative;' + (F && b.browser.version < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({height:a.p.height +
                                        (isNaN(a.p.height) ? "" : "px"),width:e.width + "px"}).scroll(e.scrollGrid);
                        ...
                        var Aa = a.p.hidegrid === true ? b("<a role='link' href='javascript:void(0)'/>").addClass("ui-jqgrid-titlebar-close HeaderButton").hover(
                                function() {
                        ...
                        if (a.p.toolbar[0]) {
                            ...
                            if (a.p.toolbar[1] == "top")b(e.uDiv).insertBefore(e.hDiv); else a.p.toolbar[1] ==
                                    "bottom" && b(e.uDiv).insertAfter(e.hDiv);
                            ...
                            if (a.p.hidegrid === true) {
                                b(".ui-jqgrid-titlebar-close", e.cDiv).click(function(d) {
                                    ...
                                    if (a.p.gridstate == "visible")b(h, "#gbox_" + a.p.id).slideUp("fast", function() {
                                        ...
                                        if (o == 0) {
                                            b("span",
                                                    p).removeClass("ui-icon-circle-triangle-n").addClass("ui-icon-circle-triangle-s");
                                        ...
                                        if (o == 0) {
                                            ...
                                            b("#gbox_" +
                                                    a.p.id).hasClass("ui-resizable") && b(".ui-resizable-handle", "#gbox_" + a.p.id).show();
                                            if (g)ba || a.p.onHeaderClick.call(a, a.p.gridstate, d)
                                        }
                                    });
                                    return false
                        ...
                        a.updatepager = function(d, g) {
                            ...
                            if (s) {
                                ...
                                if (a.p.viewrecords)if (a.p.reccount === 0)b(".ui-paging-info", s).html(a.p.emptyrecords); else {
                                    x = p + 1;
                                    C = a.p.records;
                                    if (b.fmatter) {
    ...
    b.jgrid.extend({getGridParam:function(f) {
                ...
                return this.each(function() {
                    function i(n) {
                        ...
                        if (t + n >= a + r)b(c.grid.bDiv)[0].scrollTop = t - (a + r) + n + r; else if (t < a + r)if (t < r)b(c.grid.bDiv)[0].scrollTop =
                                t
                    }
                        ...
                        if (e = c.rows.namedItem(f + "")) {
                            ...
                            if (c.p.multiselect) {
                                ...
                                if (k === -1) {
                                    ...
                                    e.className !==
                                            "ui-subgrid" && b(e).removeClass("ui-state-highlight").attr("aria-selected", "false");
                                    e = false;
                                    b("#jqg_" + c.p.id + "_" + b.jgrid.jqID(c.p.selrow)).attr("checked", e);
                    ...
                    for (; k < e;) {
                        ...
                        if (b(r).hasClass("jqgrow")) {
                            b("td", r).each(function(t) {
                                ...
                                if (a !== "cb" && a !== "subgrid" && a !== "rn")if (n.p.treeGrid === true && a == n.p.ExpandColumn)j[a] = b.jgrid.htmlDecode(b("span:first", this).html()); else try {
                                    j[a] = b.unformat(this, {rowId:r.id,
                                                colModel:n.p.colModel[t]}, t)
                                } catch(B) {
                ...
                this.each(function() {
                    ...
                    if (e)if (t === "string")b(r).addClass(i); else t === "object" && b(r).css(i)
                });
                return e
            },addRowData:function(f, j, i, c) {
                i || (i = "last");
                var e = false,k,n,a,r,t,B,F,S,
                        J = "",N,l,m,q,A;
                if (j) {
                    if (b.isArray(j)) {
                        N = true;
                    ...
                    this.each(function() {
                        ...
                        if (!N)if (typeof f != "undefined")f += ""; else {
                            f = u.p.records + 1 + "";
                        ...
                        for (var U = 0,$ = "",P = {},aa = b.isFunction(u.p.afterInsertRow) ? true : false; U < I;) {
                            ...
                            if (u.rows.length === 0)b("table:first", u.grid.bDiv).append(n); else switch (i) {
                                case "last":
                                    b(u.rows[u.rows.length -
                                            1]).after(n);
                                    break;
                                case "first":
                                    b(u.rows[0]).after(n);
                        ...
                        if (u.p.altRows === true && !N)if (i == "last")(u.rows.length - 1) % 2 == 1 && b(u.rows[u.rows.length -
                                1]).addClass(m); else b(u.rows).each(function(L) {
                    ...
                    if (i.grid) {
                        ...
                        b(this.p.colModel).each(function(k) {
                            if (b.inArray(this.name,
                                ...
                                if (j == "none")i.p.tblwidth -= this.width + i.p.cellLayout; else i.p.tblwidth += this.width;
                                this.hidden = !e;
                                c = true
                            }
                        });
                ...
                k.p.lastsort = b.inArray(k.p.lastsort,
                        f);
                        ...
                        if (!isNaN(f)) {
                            ...
                            if (j === true) {
                                ...
                                if (a !== 0) {
                                    i.p.tblwidth = e;
                                    B = f - k * a - F;
                                    if (!isNaN(i.p.height))if (b(i.grid.bDiv)[0].clientHeight <
                                            b(i.grid.bDiv)[0].scrollHeight || i.rows.length === 1) {
                                        r = true;
                                        B -= t
                                    }
                                    e = 0;
                ...
                return this.each(function() {
                    ...
                    if (n.grid) {
                        ...
                        if (a >= 0)if (r = n.rows.namedItem(f)) {
                            ...
                            if (typeof c === "string")b(B).addClass(c); else c && b(B).css(c);
                            typeof e === "object" &&
                            b(B).attr(e)
                        }
                    }
                            ...
                            if (r && r > 0) {
                                for (; t < r;) {
                                    if (b(n.rows[t]).hasClass("jqgrow")) {
                                        ...
                                        if (i)k += parseFloat(e); else if (j)c.push({id:n.rows[t].id,value:e}); else c[t] = e
                                    }
                                    t++
                                }
                ...
                return this.each(function() {
                    ...
                    if (j.grid) {
                        ...
                        if (j.p.deepempty)b("#" + j.p.id + " tbody:first tr:gt(0)").remove(); else {
...
(function(c) {
    c.fmatter = {};
    c.extend(c.fmatter, {isBoolean:function(a) {
    ...
    c.fmatter.util = {NumberFormat:function(a, b) {
        ...
        var e = b.match(/^\/Date((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?)\/$/),
                i = function(m, r) {
                    ...
                    return m
                },g = {m:1,d:1,y:1970,h:0,i:0,s:0,u:0},h = 0,j,k = ["i18n"];
        k.i18n = {dayNames:f.dayNames,monthNames:f.monthNames};
        if (a in f.masks)a = f.masks[a];
        if (b.constructor === Number)h = new Date(b); else if (b.constructor === Date)h = b; else if (e !== null) {
            ...
            h = g.y;
            if (h >= 70 && h <= 99)g.y = 1900 + g.y; else if (h >= 0 && h <= 69)g.y = 2E3 + g.y;
            h = new Date(g.y, g.m, g.d, g.h, g.i, g.s, g.u)
        }
        if (d in f.masks)d = f.masks[d]; else d || (d = "Y-m-d");
        g = h.getHours();
        a = h.getMinutes();
        b =
                h.getDate();
    ...
    c.fn.fmatter.checkbox = function(a, b) {
        ...
        c.fmatter.isUndefined(b.colModel.formatoptions) || (d = c.extend({}, d, b.colModel.formatoptions));
    ...
    c.fn.fmatter.showlink = function(a, b) {
        var d =
        {baseLinkUrl:b.baseLinkUrl,showAction:b.showAction,addParam:b.addParam || "",target:b.target,idName:b.idName},f = "";
        c.fmatter.isUndefined(b.colModel.formatoptions) || (d = c.extend({}, d, b.colModel.formatoptions));
        if (d.target)f = "target=" + d.target;
    ...
    c.fn.fmatter.select = function(a, b) {
        ...
        if (d) {
            ...
            if (c.fmatter.isString(d))for (var h = d.split(";"),j = 0,k = 0; k < h.length; k++) {
                g = h[k].split(":");
                if (g.length > 2)g[1] = jQuery.map(g,
                        function(l, o) {
                            if (o > 0)return l
                        }).join(":");
                if (e) {
    ...
    c.fn.fmatter.rowactions = function(a, b, d, f) {
        var e = {keys:false,editbutton:true,delbutton:true,onEdit:null,onSuccess:null,afterSave:null,onError:null,afterRestore:null,extraparam:{oper:"edit"},url:null,delOptions:{}};
    ...
    c.fn.fmatter.actions = function(a, b) {
        a = {keys:false,editbutton:true,delbutton:true};
        ...
        e = "onclick=$.fn.fmatter.rowactions('" +
                d + "','" + b.gid + "','save'," + b.pos + ");";
    ...
    c.unformat = function(a, b, d, f) {
        var e,i = b.colModel.formatter,g = b.colModel.formatoptions || {},h = /([\.\*\_\'\(\)\{\}\+\?\\])/g,j = b.colModel.unformat || c.fn.fmatter[i] && c.fn.fmatter[i].unformat;
        if (typeof j !== "undefined" && c.isFunction(j))e = j(c(a).text(), b, a); else if (!c.fmatter.isUndefined(i) && c.fmatter.isString(i)) {
            e = c.jgrid.formatter || {};
            switch (i) {
                case "integer":
                ...
                case "number":
                    ...
                    b = g.thousandsSeparator.replace(h,
                            "\\$1");
                    b = new RegExp(b, "g");
    ...
    c.unformat.date = function(a, b) {
        ...
        c.fmatter.isUndefined(b.formatoptions) || (d = c.extend({}, d, b.formatoptions));
        return c.fmatter.isEmpty(a) ? c.fn.fmatter.defaultFormat(a, b) : c.fmatter.util.DateFormat(d.newformat,
                a, d.srcformat, d)
    }
})(jQuery);
(function(a) {
    a.jgrid.extend({getColProp:function(f) {
                var d = {},b = this[0];
                ...
                return this.each(function() {
                    ...
                    if (m.grid) {
                        if (!f)f = m.p.sortname;
                        for (var q = 0; q < m.p.colModel.length; q++)if (m.p.colModel[q].index ==
                                f || m.p.colModel[q].name == f) {
                            t = q;
                            break
                        }
                        if (t != -1) {
                ...
                return this.each(function() {
                    if (this.grid) {
                        var f = {id:a(this).attr("id"),cl:a(this).attr("class")};
                        ...
                        if (o = h.rows.namedItem(c[d])) {
                            ...
                            if (b === true)if (h.p.jsonReader.repeatitems === true) {
                                ...
                                for (var e = 0; e < c.length; e++) {
                                    ...
                                    q = h.p.colModel[e].title ? {title:a.jgrid.stripHtml(k)} : {};
                            ...
                            a(h.p.colModel).each(function(n) {
                                ...
                                if (c[m] !== undefined) {
                                    ...
                                    q = this.title ? {title:a.jgrid.stripHtml(k)} : {};
                ...
                return this.each(function() {
                    var b = this;
                    this.p = d;
                    if (this.p.filterModel.length === 0 && this.p.gridModel === false)alert("No filter is set"); else if (f) {
                        ...
                        if (m) {
                            ...
                            var h = function() {
                                ...
                                if (b.p.url) {
                                    ...
                                    a(i).jqGrid("setGridParam", {url:b.p.url})
                                }
                                ...
                                a.each(b.p.filterModel, function() {
                                    ...
                                    switch (this.stype) {
                                        case "select":
                                            ...
                                            if (r) {
                                                g[j] = r;
                                                b.p.marksearched && a("#jqgh_" + this.name,
                                                        i.grid.hDiv).addClass("dirty-cell");
                                                n++
                                            } else {
                                                b.p.marksearched && a("#jqgh_" + this.name, i.grid.hDiv).removeClass("dirty-cell");
                                                try {
                                ...
                                l && a(i).jqGrid("setGridParam", {url:l});
                            ...
                            (function() {
                                    ...
                                    switch (this.stype) {
                                        case "select":
                                            if (this.surl)a(j).load(this.surl, function() {
                                                ...
                                                a("select", this).attr({name:l.index || l.name,id:"sg_" + l.name});
                                                l.sopt && a("select", this).attr(l.sopt);
                                                b.p.gridToolbar === true && l.width &&
                                                a("select", this).width(l.width);
                                                b.p.autosearch === true && a("select", this).change(function() {
                                                    h();
                                                    return false
                                                })
                                            }); else if (l.sopt.value) {
                                                var r = l.sopt.value,s = document.createElement("select");
                                                a(s).attr({name:l.index || l.name,id:"sg_" + l.name}).attr(l.sopt);
                                                var u;
                                                if (typeof r === "string") {
                                                    p = r.split(";");
                                        ...
                                        case "text":
                                            ...
                                            if (b.p.gridToolbar === true && l.width)a.browser.msie ? a("input", j).width(l.width -
                                                    4) : a("input", j).width(l.width - 2);
                                ...
                                if (b.p.enableClear === true || b.p.enableSearch === true)if (b.p.formtype == "horizontal")a(g).append(j); else {
                                    e = document.createElement("tr");
                ...
                f = a.extend({autosearch:true,searchOnEnter:true,beforeSearch:null,afterSearch:null,beforeClear:null,afterClear:null,searchurl:"",stringResult:false,groupOp:"AND",defaultSearch:"bw"}, f || {});
                return this.each(function() {
                    function d(h, k) {
                        var o = a(h);
                    ...
                    var b = this,m = function() {
                        ...
                        if (f.stringResult === true || b.p.datatype == "local") {
                            ...
                            i += "]}";
                            a.extend(b.p.postData, {filters:i})
                        ...
                        l || a(b).jqGrid("setGridParam", {search:n}).trigger("reloadGrid",
                                [
                                    {page:1}
                                ]);
                        p && a(b).jqGrid("setGridParam", {url:p});
                    ...
                    a.each(b.p.colModel, function() {
                        ...
                        if (typeof this.stype ==
                                "undefined")this.stype = "text";
                        c = a.extend({}, this.searchoptions || {});
                        if (this.search)switch (this.stype) {
                            case "select":
                                if (g = this.surl || c.dataUrl)a.ajax(a.extend({url:g,dataType:"html",complete:function(p) {
                                            if (c.buildSelect !== undefined)(p = c.buildSelect(p)) && a(k).append(p); else a(k).append(p.responseText);
                                            c.defaultValue && a("select", k).val(c.defaultValue);
                                            a("select", k).attr({name:h.index || h.name,id:"gs_" + h.name});
                                            c.attr && a("select", k).attr(c.attr);
                                            a("select", k).css({width:"100%"});
                                    ...
                                    var e;
                                    if (h.searchoptions && h.searchoptions.value)e = h.searchoptions.value; else if (h.editoptions && h.editoptions.value)e = h.editoptions.value;
                                    if (e) {
                                        g = document.createElement("select");
                                        g.style.width = "100%";
                                        a(g).attr({name:h.index || h.name,id:"gs_" + h.name});
                                        var n,i;
                                        if (typeof e === "string") {
                                            e =
                                                    e.split(";");
                    ...
                    this.clearToolbar = function(h) {
                        ...
                        a.each(b.p.colModel, function() {
                            ...
                            switch (this.stype) {
                                case "select":
                                    var l;
                                    a("select[name=" + g +
                                            "] option", b.grid.hDiv).each(function(u) {
                        ...
                        p || h && a(b).jqGrid("setGridParam", {search:e}).trigger("reloadGrid", [
                            {page:1}
                        ]);
                        j && a(b).jqGrid("setGridParam", {url:j});
...
(function(a) {
    a.extend(a.jgrid, {showModal:function(b) {
                ...
                var k = a("<a href='javascript:void(0)' class='ui-jqdialog-titlebar-close ui-corner-all'></a>").hover(
                        function() {
                ...
                a("a.ui-jqdialog-titlebar-close", j).click(function() {
                    var l = a("#" + b.themodal).data("onClose") || d.onClose,o = a("#" + b.themodal).data("gbox") || d.gbox;
                    n.hideModal("#" + b.themodal, {gb:o,jqm:d.jqModal,
                                onClose:l});
                    return false
                });
                ...
                if (c.left)c.left += "px";
                a(e).css(a.extend({width:isNaN(d.width) ? "auto" : d.width + "px",height:isNaN(d.height) ? "auto" : d.height + "px",zIndex:d.zIndex,overflow:"hidden"}, c)).attr({tabIndex:"-1",
                ...
                if (d.drag) {
                    a(j).css("cursor", "move");
                    if (a.fn.jqDrag)a(e).jqDrag(j); else try {
                        a(e).draggable({handle:a("#" + j.id)})
                    } catch(q) {
                    }
                }
                if (d.resize)if (a.fn.jqResize) {
                    ...
                    a("#" + b.themodal).jqResize(".jqResize", b.scrollelm ?
                            "#" + b.scrollelm : false)
                } else try {
                ...
                d.closeOnEscape === true && a(e).keydown(function(l) {
                    if (l.which == 27) {
                        ...
                        n.hideModal(this, {gb:d.gbox,jqm:d.jqModal,onClose:l})
                    }
                })
                ...
                if (a.fn.jqm && c.jqm === true)c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() :
                        a(b).attr("aria-hidden", "false").jqmShow(); else {
                    if (c.gbox !== "") {
                ...
                var g = {width:290,height:"auto",dataheight:"auto",drag:true,resize:false,caption:"<b>" + b + "</b>",left:250,top:170,zIndex:1E3,jqModal:true,modal:false,closeOnEscape:true,align:"center",buttonalign:"center",buttons:[]};
                a.extend(g, f || {});
                var h = g.jqModal,e =
                        this;
                ...
                i += "<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + f + ";" + ("text-align:" +
                        g.align + ";") + "'>" + c + "</div>";
                ...
                this.createModal({themodal:"info_dialog",modalhead:"info_head",modalcontent:"info_content",scrollelm:"infocnt"}, i, g, "", "", true);
                ...
                this.viewModal("#info_dialog", {onHide:function(k) {
                            k.w.hide().remove();
                            k.o && k.o.remove()
                        },modal:g.modal,jqm:h});
                ...
                switch (b) {
                    case "textarea":
                        ...
                        e.value = d;
                        c = h(e, c);
                        a(e).attr(c).attr({role:"textbox",multiline:"true"});
                        break;
                    case "checkbox":
                    ...
                    case "select":
                        ...
                        if (typeof c.dataUrl != "undefined")a.ajax(a.extend({url:c.dataUrl,type:"GET",dataType:"html",success:function(l) {
                                    try {
                                        delete c.dataUrl;
                                        delete c.value
                                    } catch(o) {
                    ...
                    case "button":
                        ...
                        e.value = d;
                        c = h(e, c);
                        if (b != "button")if (f)c.size || a(e).css({width:"98%"}); else if (!c.size)c.size =
                                20;
                    ...
                    case "custom":
                        ...
                        try {
                            if (a.isFunction(c.custom_element)) {
                                ...
                                if (q) {
                                    q = a(q).addClass("customelement").attr({id:c.id,name:c.name});
                                    a(e).empty().append(q)
                                } else throw"e2";
                            } else throw"e1";
                        } catch(p) {
                ...
                if (f) {
                    ...
                    if (typeof f.minValue !=
                            "undefined" && !isNaN(f.minValue))if (parseFloat(b) < parseFloat(f.minValue))return[false,h + ": " + a.jgrid.edit.msg.minValue + " " + f.minValue,""];
                    ...
                    if (f.date === true)if (!(g === false && this.isEmpty(b))) {
                        ...
                        if (!this.checkDate(c, b))return[false,h + ": " + a.jgrid.edit.msg.date +
                                " - " + c,""]
                    }
    ...
    a.jgrid.extend({searchGrid:function(e) {
                ...
                return this.each(function() {
                    function b(l, u) {
                        ...
                        if (u) {
                            ...
                            if (u.rules) {
                                ...
                                for (t = false; I < i; I++) {
                                    t = u.rules[I];
                                    if (t.field !== undefined && t.op !== undefined && t.data !== undefined)(t = l.SearchFilter.setFilter({sfref:l.SearchFilter.$.find(".sf:last"),filter:a.extend({}, t)})) && l.SearchFilter.add()
                                }
                            }
                        }
                    }
                    ...
                    function p(l) {
                        ...
                        l.hide();
                        e.overlay === true && a(".jqgrid-overlay:first",
                                "#gbox_" + w.p.id).hide()
                    }
                    ...
                    function F() {
                        ...
                        if (l > 1) {
                            ...
                            a("#" + o).css({zIndex:parseInt(u, 10) + l})
                        }
                        a("#" + o).show();
                    ...
                    function z(l) {
                        ...
                        var u = a("#" + w.p.id),t = {};
                        u[0].p.search = false;
                        if (e.multipleSearch === false)t[e.sField] = t[e.sValue] = t[e.sOper] = ""; else t[e.sFilter] = "";
                    ...
                    if (w.grid) {
                        ...
                        if (a.fn.searchFilter) {
                            ...
                            if (a("#" + o).html() != null) {
                                ...
                                var r = [],v = a("#" + w.p.id).jqGrid("getGridParam", "colNames"),d = a("#" + w.p.id).jqGrid("getGridParam", "colModel"),q = ["eq","ne","lt","le","gt","ge","bw","bn","in","ni","ew","en","cn","nc"],h,j,k,E = [];
                                if (e.sopt !== null)for (h = k = 0; h < e.sopt.length; h++) {
                                    if ((j = a.inArray(e.sopt[h], q)) != -1) {
                                        E[k] = {op:e.sopt[h],text:e.odata[j]};
                                        k++
                                    }
                                } else for (h = 0; h < q.length; h++)E[h] = {op:q[h],
                                    text:e.odata[h]};
                                a.each(d, function(l, u) {
                                    var t = typeof u.search === "undefined" ? true : u.search,I = u.hidden === true;
                                    l = a.extend({}, {text:v[l],itemval:u.index || u.name}, this.searchoptions);
                                    u = l.searchhidden === true;
                                    if (typeof l.sopt !== "undefined") {
                                        k = 0;
                                        l.ops = [];
                                        if (l.sopt.length > 0)for (h = 0; h < l.sopt.length; h++)if ((j = a.inArray(l.sopt[h], q)) != -1) {
                                            l.ops[k] = {op:l.sopt[h],text:e.odata[j]};
                                            k++
                                        }
                                    }
                                        ...
                                        if (i) {
                                            ...
                                            if (typeof i === "string") {
                                                ...
                                                for (h = 0; h < i.length; h++) {
                                                    f = i[h].split(":");
                                                    l.dataValues[h] = {value:f[0],text:f[1]}
                                                }
                                            } else if (typeof i === "object") {
                                                h = 0;
                                                for (f in i)if (i.hasOwnProperty(f)) {
                                                    l.dataValues[h] = {value:f,text:i[f]};
                                                    h++
                                                }
                                            }
                                        }
                                ...
                                if (r.length > 0) {
                                    ...
                                    w.SearchFilter = a("#" + o).searchFilter(r, {groupOps:e.groupOps,operators:E,onClose:p,resetText:e.Reset,searchText:e.Find,windowTitle:e.caption,rulesText:e.rulesText,matchText:e.matchText,onSearch:y,onReset:z,stringResult:e.stringResult,ajaxSelectOptions:a.extend({}, a.jgrid.ajaxOptions, w.p.ajaxSelectOptions || {}),clone:e.cloneSearchRowOnAdd});
                                    a(".ui-widget-overlay", "#" + o).remove();
                                    w.p.direction == "rtl" && a(".ui-closer", "#" + o).css("float", "left");
                                    if (e.drag === true) {
                                        a("#" + o + " table thead tr:first td:first").css("cursor",
                                                "move");
                                        if (jQuery.fn.jqDrag)a("#" + o).jqDrag(a("#" + o + " table thead tr:first td:first")); else try {
                                            a("#" + o).draggable({handle:a("#" + o + " table thead tr:first td:first")})
                                        } catch(P) {
                                        }
                                    }
                                    if (e.multipleSearch === false) {
                ...
                return this.each(function() {
                    ...
                    function F(g, n, x, s) {
                        ...
                        a(n.p.colModel).each(function(U) {
                            ...
                            if (G !== "cb" && G !== "subgrid" && this.editable === true && G !== "rn") {
                                if (H === false)A = ""; else if (G == n.p.ExpandColumn &&
                                        n.p.treeGrid === true)A = a("td:eq(" + U + ")", n.rows[H]).text(); else try {
                                    A = a.unformat(a("td:eq(" + U + ")", n.rows[H]), {rowId:g,colModel:this}, U)
                                } catch(da) {
                                    A = a("td:eq(" + U + ")", n.rows[H]).html()
                                }
                                var W = a.extend({}, this.editoptions || {}, {id:G,name:G}),X = a.extend({}, {elmprefix:"",elmsuffix:"",rowabove:false,rowcontent:""}, this.formoptions || {}),ba = parseInt(X.rowpos, 10) || L + 1,ea = parseInt((parseInt(X.colpos, 10) || 1) * 2, 10);
                                if (g == "_empty" && W.defaultValue)A = a.isFunction(W.defaultValue) ? W.defaultValue() : W.defaultValue;
                                if (!this.edittype)this.edittype =
                                        "text";
                                if (d.p.autoencode)A = a.jgrid.htmlDecode(A);
                                D = a.jgrid.createEl(this.edittype, W, A, false, a.extend({}, a.jgrid.ajaxOptions, n.p.ajaxSelectOptions || {}));
                        ...
                        if (L > 0) {
                            Q = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" +
                                    (s * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + n.p.id + "_id' value='" + g + "'/></td></tr>");
                            Q[0].rp = L + 999;
                            a(x).append(Q);
                                    ...
                                    if (L.defaultValue) {
                                        ...
                                        if (C[0].type == "checkbox") {
                                            ...
                                            if (M.search(/(false|0|no|off|undefined)/i) < 0 && M !== "") {
                                                ...
                                                C[0].value = A
                                            } else C.attr({checked:"",defaultChecked:""})
                                        } else C.val(A)
                                    } else if (C[0].type == "checkbox") {
                                        C[0].checked = false;
                                        C[0].defaultChecked = false;
                                        A = a(C).attr("offval")
                                    } else if (C[0].type && C[0].type.substr(0, 6) == "select")C[0].selectedIndex = 0; else C.val(A);
                            ...
                            if (S) {
                                a("td", S).each(function(H) {
                                    ...
                                    if (s !== "cb" && s !== "subgrid" && s !== "rn" && D[H].editable === true) {
                                        if (s == n.p.ExpandColumn && n.p.treeGrid === true)B = a(this).text(); else try {
                                            B = a.unformat(a(this), {rowId:g,colModel:D[H]}, H)
                                        } catch(aa) {
                                            B = a(this).html()
                                        }
                    ...
                    function z() {
                        ...
                        if (a.isFunction(c.beforeCheckValues)) {
                            var C = c.beforeCheckValues(f,
                                    a("#" + h), f[d.p.id + "_id"] == "_empty" ? s.addoper : s.editoper);
                        ...
                        if (n[0] && !c.processing) {
                            ...
                            if (f[B] != s.addoper)f[G] =
                                    f[d.p.id + "_id"]; else if (f[G] === undefined)f[G] = f[d.p.id + "_id"];
                            delete f[d.p.id + "_id"];
                            f = a.extend(f, c.editData, x);
                            x = a.extend({url:c.url ? c.url : a(d).jqGrid("getGridParam", "editurl"),type:c.mtype,data:a.isFunction(c.serializeEditData) ? c.serializeEditData(f) : f,complete:function(A, M) {
                                        if (M != "success") {
                                            n[0] = false;
                                            ...
                                            if (f[B] == s.addoper) {
                                                ...
                                                if (c.reloadAfterSubmit) {
                                                    ...
                                                    c.closeAfterEdit || setTimeout(function() {
                                                        ...
                                                        true ? a(d).jqGrid("setTreeRow", f[G], f) : a(d).jqGrid("setRowData", f[G], f);
                                                c.closeAfterEdit && a.jgrid.hideModal("#" + k.themodal, {gb:"#gbox_" + q,jqm:b.jqModal,onClose:c.onClose})
                                            }
                            ...
                            if (!x.url && !c.useDataProxy)if (a.isFunction(d.p.dataProxy))c.useDataProxy = true; else {
                                n[0] = false;
                    ...
                    function v() {
                        var g = a(d).jqGrid("getDataIDs"),n = a("#id_g", "#" + j).val();
                    ...
                    if (d.grid && e) {
                        var q = d.p.id,h = "FrmGrid_" + q,j = "TblGrid_" + q,k = {themodal:"editmod" + q,modalhead:"edithd" + q,modalcontent:"editcnt" +
                                q,scrollelm:h},E = a.isFunction(c.beforeShowForm) ? c.beforeShowForm : false,P = a.isFunction(c.afterShowForm) ? c.afterShowForm : false,l = a.isFunction(c.beforeInitData) ? c.beforeInitData : false,u = a.isFunction(c.onInitializeForm) ? c.onInitializeForm : false,t = true,I = 1,i = 0,f,J,R,O;
                        if (e == "new") {
                            e = "_empty";
                        ...
                        if (a("#" + k.themodal).html() !=
                            ...
                            y(e, d, h);
                            e == "_empty" || !c.viewPagerButtons ? a("#pData, #nData", "#" + j + "_2").hide() : a("#pData, #nData",
                                    "#" + j + "_2").show();
                            ...
                            a.jgrid.viewModal("#" + k.themodal, {gbox:"#gbox_" + q,jqm:b.jqModal,jqM:false,overlay:b.overlay,modal:b.modal});
                            T || a(".jqmOverlay").click(function() {
                                if (!o())return false;
                                a.jgrid.hideModal("#" + k.themodal, {gb:"#gbox_" + q,jqm:b.jqModal,
                                            onClose:c.onClose});
                                return false
                            });
                            P && P(a("#" + h))
                            ...
                            var Z = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>",$ = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>";
                            t = "<table border='0' cellspacing='0' cellpadding='0' class='EditTable' id='" + j + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr id='Act_Buttons'><td class='navButton'>" +
                                    (l ? V + t : t + V) + "</td><td class='EditButton'>" + Z + $ + "</td></tr>";
                            ...
                            a("#" + k.themodal).keydown(function(g) {
                                ...
                                if (g.which ===
                                        27) {
                                    if (!o())return false;
                                    ca && a.jgrid.hideModal(this, {gb:b.gbox,jqm:b.jqModal,onClose:c.onClose});
                                    return false
                                }
                                if (c.navkeys[0] === true) {
                            ...
                            if (b.closeicon[0] === true)a("#cData", "#" + j + "_2").addClass(b.closeicon[1] == "right" ? "fm-button-icon-right" :
                                    "fm-button-icon-left").append("<span class='ui-icon " + b.closeicon[2] + "'></span>");
                            if (c.checkOnSubmit || c.checkOnUpdate) {
                            ...
                            u && u(a("#" + h));
                            e == "_empty" || !c.viewPagerButtons ? a("#pData,#nData",
                                    "#" + j + "_2").hide() : a("#pData,#nData", "#" + j + "_2").show();
                            E && E(a("#" + h));
                            a("#" + k.themodal).data("onClose", c.onClose);
                            a.jgrid.viewModal("#" + k.themodal, {gbox:"#gbox_" + q,jqm:b.jqModal,overlay:b.overlay,modal:b.modal});
                            T || a(".jqmOverlay").click(function() {
                                if (!o())return false;
                                a.jgrid.hideModal("#" + k.themodal, {gb:"#gbox_" + q,jqm:b.jqModal,onClose:c.onClose});
                                return false
                            ...
                            a("#sData", "#" + j + "_2").click(function() {
                                ...
                                a("#FormError", "#" + j).hide();
                                p();
                                if (f[d.p.id + "_id"] == "_empty")z(); else if (b.checkOnSubmit === true) {
                                    R = a.extend({}, f, J);
                                    if (O = w(R, c._savedData)) {
                                        a("#" + h).data("disabled", true);
                                        a(".confirm", "#" + k.themodal).show()
                            ...
                            a("#pData", "#" + j + "_2").click(function() {
                                ...
                                if (g[0] != -1 && g[1][g[0] - 1]) {
                                    ...
                                    b.onclickPgButtons("prev", a("#" + h), g[1][g[0]]);
                                    y(g[1][g[0] - 1], d, h);
                                    a(d).jqGrid("setSelection", g[1][g[0] - 1]);
                ...
                b = a.extend({top:0,left:0,width:0,height:"auto",dataheight:"auto",modal:false,overlay:10,drag:true,resize:true,jqModal:true,closeOnEscape:false,labelswidth:"30%",closeicon:[],navkeys:[false,38,40],onClose:null,
                            beforeShowForm:null,beforeInitData:null,viewPagerButtons:true}, a.jgrid.view, b || {});
                return this.each(function() {
                    function p() {
                    ...
                    function F(i, f, J, R) {
                        ...
                        a(f.p.colModel).each(function() {
                            ...
                            if (!T && this.align === "right")if (this.formatter && a.inArray(this.formatter, n) !== -1)x = Math.max(x, parseInt(this.width, 10)); else s = Math.max(s, parseInt(this.width, 10))
                        });
                        G = x !== 0 ? x : s !== 0 ? s : 0;
                        Y = a(f).jqGrid("getInd",
                                i);
                        a(f.p.colModel).each(function(A) {
                            ...
                            if (O !== "cb" && O !== "subgrid" && O !== "rn" && C) {
                                ...
                                var M = a.extend({}, {rowabove:false,
                                            rowcontent:""}, this.formoptions || {}),D = parseInt(M.rowpos, 10) || N + 1,S = parseInt((parseInt(M.colpos, 10) || 1) * 2, 10);
                                if (M.rowabove) {
                                ...
                                B && a("td:eq(" + (S - 1) + ") span", K[0]).css({"text-align":"right",width:G + "px"});
                                $[N] = A;
                                N++
                            }
                        });
                    ...
                    function w() {
                        var i = a(o).jqGrid("getDataIDs"),f = a("#id_g", "#" + v).val();
                    ...
                    if (o.grid && e) {
                        ...
                        var m = o.p.id,r = "ViewGrid_" + m,v = "ViewTbl_" + m,d = {themodal:"viewmod" + m,modalhead:"viewhd" + m,modalcontent:"viewcnt" + m,scrollelm:r},q = a.isFunction(b.beforeInitData) ? b.beforeInitData :
                        ...
                        if (a("#" + d.themodal).html() != null) {
                            ...
                            a.jgrid.viewModal("#" + d.themodal, {gbox:"#gbox_" + m,jqm:b.jqModal,jqM:false,overlay:b.overlay,modal:b.modal});
                            p()
                        } else {
                            var E = isNaN(b.dataheight) ? b.dataheight : b.dataheight + "px";
                            E = a("<form name='FormPost' id='" + r + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" +
                                    E + ";'></form>");
                            ...
                            var l = "<a href='javascript:void(0)' id='" + (q ? "pData" : "nData") + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></a>",u = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + b.bClose + "</a>";
                            if (k > 0) {
                                var t = [];
                            ...
                            a("#" + d.themodal).keydown(function(i) {
                                if (i.which === 27) {
                                    I && a.jgrid.hideModal(this, {gb:b.gbox,jqm:b.jqModal,onClose:b.onClose});
                                    return false
                                }
                                if (b.navkeys[0] === true) {
                            ...
                            b.closeicon = a.extend([true,"left","ui-icon-close"], b.closeicon);
                            if (b.closeicon[0] === true)a("#cData", "#" + v + "_2").addClass(b.closeicon[1] == "right" ? "fm-button-icon-right" :
                                    "fm-button-icon-left").append("<span class='ui-icon " + b.closeicon[2] + "'></span>");
                            a.isFunction(b.beforeShowForm) && b.beforeShowForm(a("#" + r));
                            a.jgrid.viewModal("#" + d.themodal, {gbox:"#gbox_" + m,jqm:b.jqModal,modal:b.modal});
                ...
                c = b = a.extend({top:0,left:0,width:240,height:"auto",dataheight:"auto",modal:false,overlay:10,drag:true,resize:true,url:"",mtype:"POST",reloadAfterSubmit:true,
                            beforeShowForm:null,beforeInitData:null,afterShowForm:null,beforeSubmit:null,onclickSubmit:null,afterSubmit:null,jqModal:true,closeOnEscape:false,delData:{},delicon:[],cancelicon:[],onClose:null,ajaxDelOptions:{},processing:false,serializeDelData:null,useDataProxy:false}, a.jgrid.del, b || {});
                return this.each(function() {
                    var p = this;
                    if (p.grid)if (e) {
                        var F = typeof b.beforeShowForm === "function" ? true : false,y = typeof b.afterShowForm === "function" ? true : false,z = a.isFunction(b.beforeInitData) ? b.beforeInitData : false,
                                w = p.p.id,o = {},m = true,r = "DelTbl_" + w,v,d,q,h,j = {themodal:"delmod" + w,modalhead:"delhd" + w,modalcontent:"delcnt" + w,scrollelm:r};
                        ...
                        if (a("#" + j.themodal).html() != null) {
                            ...
                            a.jgrid.viewModal("#" + j.themodal, {gbox:"#gbox_" + w,jqm:b.jqModal,jqM:false,
                            ...
                            z += '<tr><td class="delmsg" style="white-space:pre;">' + b.msg +
                                    "</td></tr><tr><td >&#160;</td></tr>";
                            z += "</tbody></table></div>";
                            ...
                            if (b.delicon[0] === true)a("#dData", "#" + r + "_2").addClass(b.delicon[1] == "right" ? "fm-button-icon-right" : "fm-button-icon-left").append("<span class='ui-icon " +
                                    b.delicon[2] + "'></span>");
                            ...
                            a("#dData", "#" + r + "_2").click(function() {
                                ...
                                if (k[0] && !c.processing) {
                                    ...
                                    d = q.id;
                                    v[d] = E;
                                    var P = a.extend({url:c.url ? c.url : a(p).jqGrid("getGridParam", "editurl"),type:b.mtype,data:a.isFunction(b.serializeDelData) ? b.serializeDelData(v) : v,complete:function(l, u) {
                                                if (u != "success") {
                                                    k[0] = false;
                                                ...
                                                if (k[0] === false) {
                                                    ...
                                                    if (c.reloadAfterSubmit && p.p.datatype != "local")a(p).trigger("reloadGrid"); else {
                                                        u = [];
                                                        u = E.split(",");
                                                        if (p.p.treeGrid === true)try {
                                                            a(p).jqGrid("delTreeNode", u[0])
                                                        } catch(t) {
                                                        } else for (var I = 0; I < u.length; I++)a(p).jqGrid("delRowData", u[I]);
                                                        p.p.selrow = null;
                                                        p.p.selarrrow = []
                                                    }
                                                ...
                                                k[0] && a.jgrid.hideModal("#" + j.themodal, {gb:"#gbox_" +
                                    ...
                                    if (!P.url && !c.useDataProxy)if (a.isFunction(p.p.dataProxy))c.useDataProxy = true; else {
                                        k[0] = false;
                            ...
                            a("#eData", "#" + r + "_2").click(function() {
                                a.jgrid.hideModal("#" + j.themodal, {gb:"#gbox_" + w,jqm:b.jqModal,onClose:c.onClose});
                                return false
                            });
                            F && b.beforeShowForm(a("#" + r));
                            a.jgrid.viewModal("#" + j.themodal, {gbox:"#gbox_" + w,jqm:b.jqModal,overlay:b.overlay,modal:b.modal})
                        }
                ...
                b = a.extend({edit:true,editicon:"ui-icon-pencil",
                            add:true,addicon:"ui-icon-plus",del:true,delicon:"ui-icon-trash",search:true,searchicon:"ui-icon-search",refresh:true,refreshicon:"ui-icon-refresh",refreshstate:"firstpage",view:false,viewicon:"ui-icon-document",position:"left",closeOnEscape:true,beforeRefresh:null,afterRefresh:null,cloneToTop:false}, a.jgrid.nav, b || {});
                return this.each(function() {
                    var o = {themodal:"alertmod",modalhead:"alerthd",modalcontent:"alertcnt"},m = this,r,v,d;
                    if (!(!m.grid || typeof e != "string")) {
                        if (a("#" + o.themodal).html() === null) {
                            ...
                            a.jgrid.createModal(o, "<div>" + b.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>", {gbox:"#gbox_" + m.p.id,jqModal:true,drag:true,resize:true,caption:b.alertcap,top:v /
                                            2 - 25,left:r / 2 - 100,width:200,height:"auto",closeOnEscape:b.closeOnEscape}, "", "", true)
                        }
                        r = 1;
                        ...
                        for (v = 0; v < r; v++) {
                            ...
                            if (b.add) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.addtitle || "",id:F.id || "add_" + j}).click(
                                        function() {
                            ...
                            if (b.edit) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.edittitle || "",id:p.id || "edit_" + j}).click(
                                        function() {
                                            if (!a(this).hasClass("ui-state-disabled")) {
                                                var k = m.p.selrow;
                                                if (k)typeof b.editfunc == "function" ? b.editfunc(k) : a(m).jqGrid("editGridRow", k, p); else {
                                                    a.jgrid.viewModal("#" + o.themodal, {gbox:"#gbox_" + m.p.id,jqm:true});
                                                    a("#jqg_alrt").focus()
                                                }
                                            }
                                            return false
                            ...
                            if (b.view) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.viewtitle || "",id:w.id || "view_" + j}).click(
                                        function() {
                                            if (!a(this).hasClass("ui-state-disabled")) {
                                                var k = m.p.selrow;
                                                if (k)a(m).jqGrid("viewGridRow", k, w); else {
                            ...
                            if (b.del) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.deltitle || "",id:y.id || "del_" + j}).click(
                                        function() {
                                            if (!a(this).hasClass("ui-state-disabled")) {
                                                var k;
                                                if (m.p.multiselect) {
                                                ...
                                                if (k)"function" == typeof b.delfunc ? b.delfunc(k) : a(m).jqGrid("delGridRow", k, y); else {
                                                    a.jgrid.viewModal("#" + o.themodal, {gbox:"#gbox_" + m.p.id,jqm:true});
                                                    a("#jqg_alrt").focus()
                                                }
                                            }
                            ...
                            if (b.search) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.searchtitle || "",id:z.id || "search_" + j}).click(
                                        function() {
                            ...
                            if (b.refresh) {
                                ...
                                a("tr", q).append(d);
                                a(d, q).attr({title:b.refreshtitle || "",id:"refresh_" + j}).click(
                                        function() {
                                            if (!a(this).hasClass("ui-state-disabled")) {
                                                a.isFunction(b.beforeRefresh) && b.beforeRefresh();
                                                m.p.search = false;
                                                try {
                                                    a("#fbox_" + m.p.id).searchFilter().reset({reload:false});
                ...
                b = a.extend({caption:"newButton",title:"",buttonicon:"ui-icon-newwin",onClickButton:null,position:"last",cursor:"pointer"}, b || {});
                return this.each(function() {
                    if (this.grid) {
                        if (e.indexOf("#") !== 0)e = "#" + e;
                        ...
                        if (p) {
                            var y = a("<td></td>");
                            b.buttonicon.toString().toUpperCase() == "NONE" ? a(y).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'>" +
                                    b.caption + "</div>") : a(y).addClass("ui-pg-button ui-corner-all").append("<div class='ui-pg-div'><span class='ui-icon " + b.buttonicon + "'></span>" + b.caption + "</div>");
                            b.id && a(y).attr("id", b.id);
                            if (b.position == "first")p.rows[0].cells.length === 0 ? a("tr", p).append(y) : a("tr td:eq(0)", p).before(y); else a("tr", p).append(y);
                            a(y, p).attr("title", b.title || "").click(
                                    function(z) {
...
jQuery.fn.searchFilter = function(k, H) {
    function I(e, l, v) {
        ...
        if (l != null) {
            ...
            var x = e.find("tr.sf"),G = x.find("td.fields"),y = x.find("td.ops"),o = x.find("td.data"),s = "";
            ...
            e.find(".ui-search").click(function() {
                var a = jQuery(e.selector),b,d = a.find("select[name='groupOp'] :selected").val();
                b = f.stringResult ? '{"groupOp":"' +
                        d + '","rules":[' : {groupOp:d,rules:[]};
                a.find(".sf").each(function(c) {
                    var g = jQuery(this).find("select[name='field'] :selected").val(),i = jQuery(this).find("select[name='op'] :selected").val(),h = jQuery(this).find("input.vdata,select.vdata :selected").val();
                    h += "";
                    ...
                    if (f.stringResult) {
                        ...
                        b += '"op":"' + i + '",';
                        b += '"data":"' + h + '"}'
                    } else b.rules.push({field:g,op:i,data:h})
                });
                if (f.stringResult)b += "]}";
                f.onSearch(b);
                return false
            ...
            e.find(".ui-add-last").click(function() {
                var a = jQuery(e.selector + " .sf:last"),b = a.clone(true).insertAfter(a);
                b.find(".ui-state-default").removeClass("ui-state-hover ui-state-active");
                b.find(".data input").val("");
                b.find("select[name='field']").focus();
                f.datepickerFix === true && jQuery.fn.datepicker !== undefined && a.find(".hasDatepicker").each(function() {
            ...
            this.setFilter = function(a) {
                ...
                for (i = selDOMobj.options.length; c < i; c++) {
                    j[selDOMobj.options[c].value] = {index:c,ops:{}};
...
jQuery.fn.searchFilter.defaults = {clone:true,datepickerFix:true,onReset:function(k) {
...
],matchText:"match",rulesText:"rules",resetText:"Reset",searchText:"Search",stringResult:true,windowTitle:"Search Rules",ajaxSelectOptions:{}};
(function(a) {
                    ...
                    if (b.grid) {
                        ...
                        if (h !== false)if ((a(h).attr("editable") || "0") == "0" && !a(h).hasClass("not-editable-row")) {
                            ...
                            a("td", h).each(function(j) {
                                ...
                                if (v)l = a("span:first", this).html(); else try {
                                    l = a.unformat(this, {rowId:d,colModel:g[j]}, j)
                                } catch(m) {
                                    l = a(this).html()
                                }
                                if (k != "cb" && k != "subgrid" && k !=
                                    ...
                                    if (g[j].editable === true) {
                                        ...
                                        var e = a.extend({}, g[j].editoptions || {}, {id:d + "_" + k,name:k});
                                        if (!g[j].edittype)g[j].edittype = "text";
                                        e = a.jgrid.createEl(g[j].edittype, e, l, true, a.extend({}, a.jgrid.ajaxOptions, b.p.ajaxSelectOptions || {}));
                            ...
                            if (l === "1") {
                                ...
                                if (p[0] === false)try {
                                    ...
                                    if (i == "clientArray") {
                                        ...
                                        a(q).attr("editable", "0");
                                        for (g = 0; g < c.p.savedRow.length; g++)if (c.p.savedRow[g].id ==
                                                d) {
                                            t = g;
                                            break
                                        }
                                        ...
                                        a("#lui_" + c.p.id).show();
                                        a.ajax(a.extend({url:i,data:a.isFunction(c.p.serializeRowData) ? c.p.serializeRowData.call(c, b) : b,type:"POST",complete:function(m, e) {
                                                    a("#lui_" + c.p.id).hide();
                                                    if (e === "success")if ((a.isFunction(u) ? u.call(c, m) : true) === true) {
                                                        ...
                                                        a(q).attr("editable", "0");
                                                        for (e = 0; e < c.p.savedRow.length; e++)if (c.p.savedRow[e].id ==
                                                                d) {
                                                            t = e;
                                                            break
                                                        }
    ...
    b.jgrid.extend({editCell:function(d, e, a) {
                                ...
                                if (r[0] === true) {
                                    ...
                                    if (a.p.cellsubmit == "remote")if (a.p.cellurl) {
                                        ...
                                        b.ajax(b.extend({url:a.p.cellurl,data:b.isFunction(a.p.serializeCellData) ?
                                                    ...
                                                    b("#lui_" + a.p.id).hide();
                                                    a.grid.hDiv.loading = false;
                                                    b.isFunction(a.p.errorCell) ? a.p.errorCell.call(a, m, p) : b.jgrid.info_dialog(b.jgrid.errors.errcap, m.status + " : " + m.statusText + "<br/>" +
                ...
                return this.each(function() {
                    ...
                    if (!(!a.grid ||
                        ...
                        if (c !== false)b(a).jqGrid("editCell", d, c, true); else a.p.savedRow.length > 0 && b(a).jqGrid("saveCell", d, e)
                    }
                })
                ...
                return this.each(function() {
                    function d(g, k, j) {
                        if (j.substr(0, 1) == "v") {
                            var i = b(a.grid.bDiv)[0].clientHeight,l = b(a.grid.bDiv)[0].scrollTop,n = a.rows[g].offsetTop + a.rows[g].clientHeight,q = a.rows[g].offsetTop;
                        ...
                        if (j == "h") {
                            ...
                            if (a.rows[g].cells[k].offsetLeft + a.rows[g].cells[k].clientWidth >=
...
(function(b) {
    b.fn.jqm = function(a) {
        ...
        return this.each(function() {
            ...
            l++;
            this._jqm = l;
            i[l] = {c:b.extend(f, b.jqm.params, a),a:e,w:b(this).addClass("jqmID" + l),s:l};
    ...
    b.jqm = {hash:{},open:function(a, f) {
        var c = i[a],d = c.c,h = "." + d.closeClass,g = parseInt(c.w.css("z-index"));
        g = g > 0 ? g : 3E3;
        var j = b("<div></div>").css({height:"100%",width:"100%",position:"fixed",left:0,top:0,"z-index":g - 1,opacity:d.overlay / 100});
        if (c.a)return e;
        c.t = f;
        c.a = true;
        c.w.css("z-index", g);
        if (d.modal) {
            ...
            k.push(a)
        } else if (d.overlay > 0)d.closeoverlay && c.w.jqmAddClose(j); else j = e;
        c.o = j ? j.addClass(d.overlayClass).prependTo("body") : e;
        if (q) {
            b("html,body").css({height:"100%",width:"100%"});
            if (j) {
                j = j.css({position:"absolute"})[0];
                for (var m in{Top:1,Left:1})j.style.setExpression(m.toLowerCase(), "(_=(document.documentElement.scroll" + m + " || document.body.scroll" + m + "))+'px'")
            }
        }
        if (d.ajax) {
            a = d.target || c.w;
    ...
    var l =
            0,i = b.jqm.hash,k = [],q = b.browser.msie && b.browser.version == "6.0",e = false,r = function(a) {
            ...
            b(f).each(function() {
                if (!this[c]) {
                    ...
                    b(this).click(function() {
                        for (var h in{jqmShow:1,jqmHide:1})for (var g in this[h])i[this[h][g]] && i[this[h][g]].w[h](this);
                        return e
                    })
                }
                this[c].push(d)
                ...
                return this.each(function() {
                    ...
                    if (a.grid) {
                        var n = function(g, j, f) {
                            ...
                            var f,
                                    d,h,i = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),k = b("<tr></tr>");
                            ...
                            if (g) {
                                ...
                                b(h.root + " " + h.row, g).each(function() {
                                    ...
                                    if (h.repeatitems === true)b(h.cell,
                            ...
                            if (!a.grid.hDiv.loading) {
                                ...
                                if (b.isFunction(a.p.subgridtype))a.p.subgridtype.call(a, f); else a.p.subgridtype = a.p.subgridtype.toLowerCase();
    ...
    f.jgrid.extend({groupingSetup:function() {
                return this.each(function() {
                    ...
                    if (b !== null && (typeof b === "object" || f.isFunction(b)))if (b.groupField.length) {
                        for (var a = 0; a < b.groupField.length; a++) {
                            ...
                            b.groupColumnShow[a] === true ? f(c).jqGrid("showCol", b.groupField[a]) :
                                    f(c).jqGrid("hideCol", b.groupField[a]);
                            b.sortitems[a] = [];
                            b.sortnames[a] = [];
                            b.summaryval[a] = [];
                            if (b.groupSummary[a]) {
                                b.summary[a] = [];
                                for (var d = c.p.colModel,e = 0,g = d.length; e < g; e++)d[e].summaryType && b.summary[a].push({nm:d[e].name,st:d[e].summaryType,v:""})
                            }
                        }
                        c.p.scroll = false;
                ...
                this.each(function() {
                    ...
                    var e = b[0].toString().split(" ").join(""),
                            g = this.p.groupingView,j = this;
                    if (a.hasOwnProperty(e))a[e].push(c); else {
                        a[e] = [];
                        a[e].push(c);
            ...
            },groupingCalculations:{sum:function(c, b, a) {
    ...
    d.jgrid.extend({setTreeNode:function(b, c) {
                return this.each(function() {
                    ...
                    if (a.grid && a.p.treeGrid) {
                        ...
                        g =
                                "<div class='tree-wrap tree-wrap-" + a.p.direction + "' style='width:" + g * 18 + "px;'>";
                ...
                return this.each(function() {
                    ...
                    if (b.p.treeGrid) {
                        ...
                        b.p.rowList = [];
                        b.p.treeIcons = d.extend({plus:"ui-icon-triangle-1-" + (b.p.direction == "rtl" ? "w" : "e"),minus:"ui-icon-triangle-1-s",leaf:"ui-icon-radio-off"}, b.p.treeIcons || {});
                        if (b.p.treeGridModel == "nested")b.p.treeReader =
                                d.extend({level_field:"level",left_field:"lft",right_field:"rgt",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded"}, b.p.treeReader); else if (b.p.treeGridModel == "adjacency")b.p.treeReader = d.extend({level_field:"level",parent_id_field:"parent",leaf_field:"isLeaf",expanded_field:"expanded",loaded:"loaded"}, b.p.treeReader);
                ...
                getNodeParent:function(b) {
                    ...
                    this.each(function() {
                        ...
                        if (a.grid && a.p.treeGrid)switch (a.p.treeGridModel) {
                            case "nested":
                                var f = a.p.treeReader.left_field,e = a.p.treeReader.right_field,k = a.p.treeReader.level_field,i = parseInt(b[f], 10),l = parseInt(b[e], 10),g = parseInt(b[k], 10);
                    ...
                    this.each(function() {
                        ...
                        if (a.grid && a.p.treeGrid)switch (a.p.treeGridModel) {
                            case "nested":
                                var e = a.p.treeReader.left_field,k = a.p.treeReader.right_field,i = a.p.treeReader.level_field,l = parseInt(b[e], 10),g = parseInt(b[k], 10),j = parseInt(b[i], 10);
                                d(this.p.data).each(function() {
                    ...
                    this.each(function() {
                        ...
                        if (a.grid && a.p.treeGrid) {
                            var f =
                                    d(a).jqGrid("getNodeAncestors", b),e = a.p.treeReader.expanded_field;
                            d(f).each(function() {
                                c = c && this[e];
                                if (!c)return false
                            })
                        ...
                        if (this.grid && this.p.treeGrid) {
                            ...
                            if (!b[c]) {
                                var a = d.jgrid.getAccessor(b,
                                        this.p.localReader.id),f = d("#" + a, this.grid.bDiv)[0],e = this.p._index[a];
                                if (d(this).jqGrid("isNodeLoaded", this.p.data[e])) {
                                    ...
                                    this.p.treeGridModel == "nested" ? d(this).jqGrid("setGridParam",
                                            {postData:{nodeid:a,n_left:b.lft,n_right:b.rgt,n_level:b.level}}) : d(this).jqGrid("setGridParam", {postData:{nodeid:a,parentid:b.parent_id,n_level:b.level}});
                    ...
                    var d = this,c = function(e, g) {
                        ...
                        if (xmlJsonClass.xml2json && b.jgrid.parse) {
                            ...
                            if (g) {
                                ...
                                f.grid.datastr = e;
                                b(d).jqGrid(k).jqGrid("setGridParam", {datatype:h})
                            } else b(d).jqGrid(k)
                        ...
                        if (e && typeof e == "string") {
                            ...
                            if (g = f[g.jsonGrid.data]) {
                                ...
                                e.datastr = g;
                                b(d).jqGrid(e).jqGrid("setGridParam", {datatype:f})
                            } else b(d).jqGrid(e)
                        }
                    };
                    switch (a.imptype) {
                        ...
                        case "xmlstring":
                            ...
                            break;
                        case "json":
                            b.ajax(b.extend({url:a.impurl,type:a.mtype,data:a.impData,dataType:"json",complete:function(e, g) {
                                        if (g == "success") {
                                            i(e.responseText, a);
...
var xmlJsonClass = {xml2json:function(a, b) {
    ...
    var g = function(d, c, j) {
        ...
        if (d instanceof Array)if (d.length === 0)i += j + "<" + c + ">__EMPTY_ARRAY_</" + c + ">\n"; else {
            ...
            for (h in d)if (d.hasOwnProperty(h))if (h.charAt(0) ===
                    "@")i += " " + h.substr(1) + '="' + d[h].toString() + '"'; else k = true;
            i += k ? ">" : "/>";
            if (k) {
                for (h in d)if (d.hasOwnProperty(h))if (h === "#text")i += d[h]; else if (h === "#cdata")i += "<![CDATA[" + d[h] + "]]\>"; else if (h.charAt(0) !== "@")i += g(d[h], h, j + "\t");
    ...
    if (a === "[]")e += b ? ":[]" : "[]"; else if (a instanceof Array) {
        ...
        e += (b ? ":[" : "[") + (c.length > 1 ? "\n" + g + "\t" + c.join(",\n" + g + "\t") + "\n" + g : c.join("")) + "]"
    } else if (a === null)e += (b && ":") + "null"; else if (typeof a === "object") {
        f = [];
                ...
                return this.each(function() {
                    ...
                    if (c.grid) {
                        var j = typeof a.beforeShowForm ===
                                "function" ? true : false,k = typeof a.afterShowForm === "function" ? true : false,l = typeof a.afterSubmitForm === "function" ? true : false,e = c.p.id,d = "ColTbl_" + e,f = {themodal:"colmod" + e,modalhead:"colhd" + e,modalcontent:"colcnt" + e,scrollelm:d};
                        a.recreateForm === true && b("#" + f.themodal).html() != null && b("#" + f.themodal).remove();
                        if (b("#" + f.themodal).html() != null) {
                            j && a.beforeShowForm(b("#" + d));
                            b.jgrid.viewModal("#" + f.themodal, {gbox:"#gbox_" + e,jqm:a.jqModal,jqM:false,modal:a.modal})
                        } else {
                            ...
                            for (i = 0; i < this.p.colNames.length; i++)c.p.colModel[i].hidedlg || (g += "<tr><td style='white-space: pre;'><input type='checkbox' style='margin-right:5px;' id='col_" + this.p.colModel[i].name + "' class='cbox' value='T' " + (this.p.colModel[i].hidden === false ? "checked" : "") + "/><label for='col_" + this.p.colModel[i].name +
                                    "'>" + this.p.colNames[i] + (a.colnameview ? " (" + this.p.colModel[i].name + ")" : "") + "</label></td></tr>");
                            g += "</tbody></table></div>";
                            ...
                            a.updateAfterCheck ?
                                ...
                                for (i = 0; i < c.p.colModel.length; i++)if (!c.p.colModel[i].hidedlg) {
                                    var h = c.p.colModel[i].name.replace(/\./g, "\\.");
                                ...
                                a.ShrinkToFit === true && b(c).jqGrid("setGridWidth", c.grid.width - 0.0010, true);
                                a.closeAfterSubmit && b.jgrid.hideModal("#" + f.themodal, {gb:"#gbox_" + e,jqm:a.jqModal,onClose:a.onClose});
                                l && a.afterSubmitForm(b("#" + d));
                                return false
                            });
                            b("#eData", "#" + d + "_2").click(function() {
                                b.jgrid.hideModal("#" + f.themodal, {gb:"#gbox_" + e,jqm:a.jqModal,onClose:a.onClose});
                                return false
                            });
                            ...
                            j && a.beforeShowForm(b("#" + d));
                            b.jgrid.viewModal("#" + f.themodal, {gbox:"#gbox_" + e,jqm:a.jqModal,jqM:true,modal:a.modal})
                        }
...
(function(c) {
    c.jgrid.extend({getPostData:function() {
                ...
                var b = this[0];
                if (b.grid)if (typeof a === "object")b.p.postData = a; else alert("Error: cannot add a non-object postData value. postData unchanged.")
...
(function(a) {
    ...
    a.jgrid.extend({sortableColumns:function(b) {
                return this.each(function() {
                    ...
                    var c = this,h = {tolerance:"pointer",axis:"x",scrollSensitivity:"1",items:">th:not(:has(#jqgh_cb,#jqgh_rn,#jqgh_subgrid),:hidden)",placeholder:{element:function(e) {
                        ...
                        g.height(e.currentItem.innerHeight() - parseInt(e.currentItem.css("paddingTop") || 0, 10) - parseInt(e.currentItem.css("paddingBottom") || 0, 10));
                        g.width(e.currentItem.innerWidth() - parseInt(e.currentItem.css("paddingLeft") || 0, 10) - parseInt(e.currentItem.css("paddingRight") || 0, 10))
                    }},update:function(e, g) {
                        e = a(g.item).parent();
                        e = a(">th", e);
                        var i = {};
                    ...
                    if (c.p.sortable.options)a.extend(h, c.p.sortable.options); else if (a.isFunction(c.p.sortable))c.p.sortable = {update:c.p.sortable};
                    if (h.start) {
                        var d = h.start;
                    ...
                    if (c.p.sortable.exclude)h.items += ":not(" + c.p.sortable.exclude +
                            ")";
                ...
                function c(f, k) {
                    if (f)if (typeof f == "string")a.fn[f] && a.fn[f].apply(k, a.makeArray(arguments).slice(2)); else a.isFunction(f) && f.apply(k, a.makeArray(arguments).slice(2))
                }
                ...
                if (!a("#colchooser_" + h[0].p.id).length) {
                    var d = a('<div id="colchooser_' + h[0].p.id + '" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'),
                            e = a("select", d);
                    b = a.extend({width:420,height:240,classname:null,done:function(f) {
                                f && h.jqGrid("remapColumns", f, true)
                            },msel:"multiselect",dlog:"dialog",dlog_opts:function(f) {
                                var k = {};
                                ...
                                return{buttons:k,close:function() {
                                    f.cleanup(true)
                    ...
                    if (b.width) {
                        a(">div", d).css({width:b.width,margin:"0 auto"});
                        e.css("width", b.width)
                    }
                    if (b.height) {
                    ...
                    var g = h.jqGrid("getGridParam", "colModel"),i = h.jqGrid("getGridParam", "colNames"),l = {},m = [];
                    e.empty();
                    a.each(g, function(f) {
                        l[this.name] = f;
                    ...
                    var n = a.isFunction(b.dlog_opts) ? b.dlog_opts.call(h, b) : b.dlog_opts;
                    c(b.dlog, d, n);
                    n = a.isFunction(b.msel_opts) ? b.msel_opts.call(h, b) : b.msel_opts;
                    c(b.msel, e, n)
                }
            },sortableRows:function(b) {
                return this.each(function() {
                    var j = this;
                    if (j.grid)if (!j.p.treeGrid)if (a.fn.sortable) {
                        b = a.extend({cursor:"move",axis:"y",items:".jqgrow"}, b || {});
                        ...
                        b.update = function(c, h) {
                            ...
                            j.p.rownumbers === true && a("td.jqgrid-rownum", j.rows).each(function(d) {
                                a(this).html(d +
                                        1)
                            });
                        ...
                        if (typeof b == "string" && b ==
                            ...
                            b = a.extend({drag:function(d) {
                                        return a.extend({start:function(e, g) {
                                                    ...
                                                    g.helper.addClass("ui-state-highlight");
                                                    a("td", g.helper).each(function(m) {
                                                    ...
                                                    d.onstop && a.isFunction(d.onstop) && d.onstop.call(a(c), e, g)
                                                }}, d.drag_opts || {})
                                    },drop:function(d) {
                                        return a.extend({accept:function(e) {
                                                    if (!a(e).hasClass("jqgrow"))return e;
                                                    var g = a(e).closest("table.ui-jqgrid-btable");
                                                    if (g.length >
                                                            0 && a.data(g[0], "dnd") !== undefined) {
                                                    ...
                                                    if (a(g.draggable).hasClass("jqgrow")) {
                                                        var i = a(g.draggable).attr("id");
                                                        i = g.draggable.parent().parent().jqGrid("getRowData", i);
                                                        if (!d.dropbyname) {
                                                            var l = 0,m = {},n,f = a("#" + this.id).jqGrid("getGridParam", "colModel");
                                                            try {
                                                                for (var k in i) {
                                                                    if (i.hasOwnProperty(k) && f[l]) {
                                                                        n = f[l].name;
                                                                        m[n] = i[k]
                                                                    }
                                                                    l++
                                                        ...
                                                        if (d.beforedrop && a.isFunction(d.beforedrop)) {
                                                            n =
                                                                    d.beforedrop.call(this, e, g, i, a("#" + c.id), a(this));
                                                            if (typeof n != "undefined" && n !== null && typeof n == "object")i = n
                                                        }
                                                        if (g.helper.dropped) {
                                                            var o;
                                                            if (d.autoid)if (a.isFunction(d.autoid))o = d.autoid.call(this, i); else {
                                                                o = Math.ceil(Math.random() * 1E3);
                                                                o = d.autoidprefix + o
                                                            }
                                                            a("#" + this.id).jqGrid("addRowData", o, i, d.droppos)
                                                        }
                                                        d.ondrop && a.isFunction(d.ondrop) && d.ondrop.call(this, e, g, i)
                                                    }
                                                }}, d.drop_opts || {})
                                    },onstart:null,onstop:null,beforedrop:null,ondrop:null,drop_opts:{activeClass:"ui-state-active",hoverClass:"ui-state-hover"},
                                        drag_opts:{revert:"invalid",helper:"clone",cursor:"move",appendTo:"#jqgrid_dnd",zIndex:5E3},dropbyname:false,droppos:"first",autoid:true,autoidprefix:"dnd_"}, b || {});
                            if (b.connectWith) {
                                ...
                                c.p.jqgdnd = true;
                                for (var h = 0; h < b.connectWith.length; h++)a(b.connectWith[h]).droppable(a.isFunction(b.drop) ? b.drop.call(a(c), b) : b.drop)
                            }
                        }
                    }
                })
                ...
                return this.each(function() {
                    ...
                    if (j.grid && a.fn.resizable) {
                        ...
                        b.stop = function(c, h) {
                            a(j).jqGrid("setGridParam", {height:a("#gview_" + j.p.id + " .ui-jqgrid-bdiv").height()});
                            a(j).jqGrid("setGridWidth", h.size.width, b.shrinkToFit);
                            b._stop_ && b._stop_.call(j, c, h)
                        };
                        b.alsoResize = b._alsoResize_ ? eval("(" + ("{'#gview_" + j.p.id + " .ui-jqgrid-bdiv':true,'" +
                                b._alsoResize_ + "':true}") + ")") : a(".ui-jqgrid-bdiv", "#gview_" + j.p.id);
